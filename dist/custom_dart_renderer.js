...
exports.CustomDartRenderer = exports.CustomDartTargetLanguage = exports.dartOptions = void 0;
const collection_utils_1 = require("collection-utils");
const Annotation_1 = require("quicktype-core/dist/Annotation");
const ConvenienceRenderer_1 = require("quicktype-core/dist/ConvenienceRenderer");
const Naming_1 = require("quicktype-core/dist/Naming");
...
const Support_1 = require("quicktype-core/dist/support/Support");
const TargetLanguage_1 = require("quicktype-core/dist/TargetLanguage");
const Type_1 = require("quicktype-core/dist/Type");
...
class CustomDartRenderer extends ConvenienceRenderer_1.ConvenienceRenderer {
    ...
    emitSourceStructure() {
        ...
        this.forEachNamedType("leading-and-interposing", (c, n) => this._options.useFreezed
            ? this.emitFreezedClassDefinition(c, n)
            : this.emitClassDefinition(c, n), (e, n) => this.emitEnumDefinition(e, n), (_e, _n) => {
...
exports.CustomDartRenderer = CustomDartRenderer;
